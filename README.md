...
### Principais Seções:
- **Home:** Apresentação de impacto com foco em tecnologias e stack principal.
- **Sobre Mim:** Detalhes sobre minha formação acadêmica no CEUB e atuação como Educador Social Voluntário.
- **Habilidades:** Demonstração técnica de competências em Python, Banco de Dados e IA.
